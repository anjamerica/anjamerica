      ...
      >
        <div className="flex flex-col gap-0">
          <div className="flex flex-col lg:flex-row -mb-2 justify-between sm:w-[90%] h-fit items-start">
            <span className="text-[16px] 2xl:text-[20px] self-start md:text-base font-semibold">
              {item?.job_title}
            </span>
            <span className="flex flex-row self-start h-fit w-fit items-center gap-[4px] md:gap-1">
              {item?.ref_id && (
                <p className="text-[.8rem] md:text-[16px] 2xl:text-[20px] md:text-base font-semibold">
                  Ref ID: {item?.ref_id}
                </p>
              )}
          ...
          <div className="p-0 mt-2">
            <span className="text-xs 2xl:text-[16px] text-[#333] self-start font-light break-words">
              Posted Date : {date}
            </span>
          </div>
        </div>
        ...
        <div>
          <p className="text-xs xl:text-[14px] max-h-[2.8rem] 2xl:leading-[24px] 2xl:max-h-[4rem] 2xl:text-[20px] text-primary-gray font-light break-words overflow-y-hidden text-justify">
            {item?.description}
          </p>
        </div>
        <div className="flex flex-col mt-2 w-fit gap-2 md:gap-[64px] justify-between md:flex-row md:mt-0">
          <span className="text-xs  text-[#046AC8] 2xl:text-[1rem] md:font-semibold">
