...
export default function ApplicationDetails({ item, filter }) {
  ...
  return (
    <>
      ...
      >
        <td className="text-black  text-sm md:text-md 2xl:text-[18px] font-normal px-5 md:px-3 break-words">
          {item.app_id}
        </td>
        <td className="text-black  text-sm md:text-md 2xl:text-[18px] font-normal px-2 py-3 break-words">
          {item.name}
        </td>
        <td className="text-black  text-sm md:text-md 2xl:text-[18px] font-normal px-2 py-3 break-words">
        ...
        <td className="text-black w-40 text-sm md:text-md 2xl:text-[18px] font-normal px-2 py-3 break-words">
          {item.email}
        </td>
