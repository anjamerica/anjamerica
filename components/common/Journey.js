...
const Journey = () => {
  const services = [
    {
      image:
        "https://nichetechies-public.s3.us-east-2.amazonaws.com/ANJ_WEBSITE/WEB/assets/blogs/journey1.webp",
    ...
    {
      image:
        "https://nichetechies-public.s3.us-east-2.amazonaws.com/ANJ_WEBSITE/WEB/assets/blogs/journey2.webp",
    ...
    {
      image:
        "https://nichetechies-public.s3.us-east-2.amazonaws.com/ANJ_WEBSITE/WEB/assets/blogs/journey3.webp",
    ...
    {
      image:
        "https://nichetechies-public.s3.us-east-2.amazonaws.com/ANJ_WEBSITE/WEB/assets/blogs/journey4.webp",
      title: "Well-being",
      description:
  ...
  return (
    <div className="w-full p-5 mt-2 md:mt-5 mb-2 md:mb-5 md:px-5 md:pt-5 pt-8 bg-white rounded-[20px] flex flex-col gap-6 items-center justify-center">
      <p
        data-aos="fade-up"
  ...
  return (
    ...
    >
      <img
        ...
        data-aos-duration="1500"
        data-aos-anchor-placement="center-bottom"
        className="w-full md:w-1/2 h-fit max-h-[352px] xl:w-[498px] xl:h-[352px]  rounded-lg object-cover flex items-end"
        src={item?.image}
      />
      <div
        className={`flex flex-col lg:max-w-[500px] gap-3 ${
      ...
      >
        ...
        <p className="text-base text-[#1E1E1E] text-justify font-light leading-[29px]">
          {item?.description}
        </p>
        {/* <a
          href={item?.linkTo}
