    ...
    <main className="mx-auto w-full h-full snap-y">
      ...
      <section id="hiring">
        <div className="px-10 md:px-20  py-20">
          <p className="text-[#33b5af] text-[.85rem]  text-left font-semibold tracking-[1px] break-words md:text-[15px] 2xl:text-[20px]">
            OUR SELECTION PROCESS
          </p>
          <p className="text-[#0a1f44] text-[30px] heading-main mt-1 leading-[33px] md:text-[24px] 2xl:text-[30px] md:leading-[45px] font-bold">
            Hiring Process
          </p>
          ...
          <div className="flex flex-col lg:flex-row lg:gap-4 justify-between w-full mt-10">
            ...
            <div className="relative flex flex-col gap-2">
              <p className=" text-[#333] text-[16px] font-bold md:text-[20px] 2xl:text-[24px] heading-main leading-[30px] z-10 text-base mt-6">
            ...
            <div className="relative flex flex-col gap-2">
              <p className=" text-[#333] text-[16px] font-bold md:text-[20px] 2xl:text-[24px] heading-main z-10 leading-[30px] text-base mt-6">
