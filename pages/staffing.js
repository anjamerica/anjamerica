    ...
    <main className="mx-auto w-full h-full snap-y">
      ...
      <section className="staffing-bg">
        <div className="flex flex-col w-full px-10 md:px-20 mt-24">
          ...
          <p className="text-normal-digitze text-anim-blog">
            ...
            <br /> world. We have an exclusive pool of the top niche
            <br /> Professionals who can be sourced to your project
      ...
      <section id="hiring">
        <div className="px-10 py-20">
          ...
          <p className="w-full text-[#0a1f44] text-[.85rem] text-left break-words md:text-[1rem]">
          ...
          <div className="flex flex-col md:flex-row md:gap-8 justify-between w-full mt-8">
